...
default_ec = 0.24  # (€/kWh) charging price for EV driver
default_e_tax = 0.15  # (€/kWh) total taxes and other charges
default_cx = 300000  # (€) total installation costs of charging station installation
default_cy = 127000  # (€) total installation costs of charging pole installation
default_eta = 0.33  # share of electric vehicles of car fleet
default_mu = 0.24  # share of cars travelling long-distance
default_gamma_h = 0.12  # share of cars travelling during peak hour
default_a = 0.69
