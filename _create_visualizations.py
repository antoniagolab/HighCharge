...
axs[0].scatter(
    plot_df["x"], plot_df["y"], s=90, color="#ced4da", label="1-4 occurrences", zorder=20
)

# cat 1: "5-9"
plot_df = merge_2[merge_2["always_there"].isin(range(5, 10))]
axs[0].scatter(
    plot_df["x"], plot_df["y"], s=90, color="#adb5bd", label="5-9 occurrences", zorder=20
)

# cat 2: "10-12"
plot_df = merge_2[merge_2["always_there"].isin(range(10, 13))]
axs[0].scatter(
    plot_df["x"], plot_df["y"], s=90, color="#6c757d", label="10-12 occurrences", zorder=20
)
...
axs[0].scatter(
    plot_df["x"], plot_df["y"], s=90, color="#212529", label="occurrence in every SA model run", zorder=20
)
...
axs[1].scatter(
    cat["x"], cat["y"], s=90, color=colors[2], label="Part of existing infrastructure", zorder=20
)
...
axs[1].scatter(
    cat["x"], cat["y"], s=90, color=colors[1], label="Constant occurrence during SA", zorder=20
)
...
ax1.set_ylabel("Nb. of charging stations", labelpad=12, fontname="Franklin Gothic Book", fontsize=12)
...
sens_data = pd.read_csv("sensitivity_analyses/sensitivity_anal_epsilon_part_SC_1002.csv")
...
# ax2 = ax.twinx()
# ax2.set_ylim([0,30])
l2 = ax3.bar(list(ranges), installed_caps, width=8, zorder=20, color="#f4a261", label="Total capacity")
...
# ax2.grid(False)
# ax.grid(False)
ax4.annotate('', xy=(0, -0.25), xycoords='axes fraction', xytext=(1, -0.25),
    arrowprops=dict(arrowstyle="-", color='grey', linewidth=2))
ax2.annotate('', xy=(0, 1), xycoords='axes fraction', xytext=(1, 1),
    arrowprops=dict(arrowstyle="-", color='grey', linewidth=2))

ax4.annotate('|', fontsize=20, xy=(0.02, -0.25), color='grey', xycoords='axes fraction', va='center', ha='center')
ax4.annotate('|', fontsize=20, xy=(0.3, -0.25), color='grey', xycoords='axes fraction', va='center', ha='center')
ax4.annotate('|', fontsize=20, xy=(0.918, -0.25), color='grey', xycoords='axes fraction', va='center', ha='center')

ax2.annotate('|', fontsize=20, xy=(0.02, 1), color='grey', xycoords='axes fraction', va='center', ha='center')
ax2.annotate('|', fontsize=20, xy=(0.3, 1), color='grey', xycoords='axes fraction', va='center', ha='center')
ax2.annotate('|', fontsize=20, xy=(0.918, 1), color='grey', xycoords='axes fraction', va='center', ha='center')

offset1 = -0.35
offset = 1 - 0.1
ax4.annotate('2020', fontsize=11, xy=(0.02, offset1), color='grey', xycoords='axes fraction', va='center', ha='center')
ax4.annotate('2030', fontsize=11, xy=(0.3, offset1), color='grey', xycoords='axes fraction', va='center', ha='center')
ax4.annotate('2040', fontsize=11, xy=(0.918, offset1), color='grey', xycoords='axes fraction', va='center', ha='center')
ax2.annotate('2020', fontsize=11, xy=(0.02, offset), color='grey', xycoords='axes fraction', va='center', ha='center')
ax2.annotate('2030', fontsize=11, xy=(0.3, offset), color='grey', xycoords='axes fraction', va='center', ha='center')
ax2.annotate('2040', fontsize=11, xy=(0.918, offset), color='grey', xycoords='axes fraction', va='center', ha='center')
ax4.annotate('year', fontsize=12, xy=(-0.1, -0.25), color='grey', xycoords='axes fraction', va='center', ha='center')
ax2.annotate('year', fontsize=12, xy=(-0.1, 1), color='grey', xycoords='axes fraction', va='center', ha='center')
...
ax2.set_yticklabels(labels=[str(el) for el in [0, 50, 100, 150, 200, 250]], fontname="Franklin Gothic Book")
...
lns = [l2] + l0 + l1
labs = [l.get_label() for l in lns]
ax2.legend(lns + [blue_patch] + [median_patch], labs + [blue_patch._label,
                                                        'Median of CP at CS'],
           bbox_to_anchor=(-0.1, -0.3, 1, 1), fontsize=12)

ax4.set_ylabel("Nb. of charging points per charging station", fontname="Franklin Gothic Book", fontsize=12)
ax2.axis('off')
plt.tight_layout()
