...
existing_infr = existing_infr.drop_duplicates(
    subset=["highway", "name", "asfinag_position"]
)
...
installed_cap = (
    existing_infr["44kW"] * 44
    + existing_infr["50kW"] * 50
    + existing_infr["75kW"] * 75
    + existing_infr["150kW"] * 150
    + existing_infr["350kW"] * 350
)
