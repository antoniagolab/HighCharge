...
#         mask_1,
#         path_directory,
#     ) = create_mask_enum(model, dir_0, dir_1, links_gdf, segments_gdf, dist_max)
...
#
#     return sum(pXi) - installed_stations, sum(pYi_dir_0) + sum(pYi_dir_1) - installed_poles,\
#            not_charged_energy + not_charged_2, test_var_0_m, test_var_1_m, pE_input_0_m, pE_output_0_m, pE_charged_0_m
#
#
# #
